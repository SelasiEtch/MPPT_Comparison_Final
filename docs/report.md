...
Figure 1: Standard Buck Converter Design (https://github.com/SelasiEtch/MPPT_Comparison_Final/blob/main/docs/media/Figure_1.png)
...
Figure 2: High Level Schematic of Arduino Motor Driver Shield (https://github.com/SelasiEtch/MPPT_Comparison_Final/blob/main/docs/media/Figure_2_a.jpg) and Project Implementation (https://github.com/SelasiEtch/MPPT_Comparison_Final/blob/main/docs/media/Figure_2_b.jpg) 
...
System Diagram: (https://github.com/SelasiEtch/MPPT_Comparison_Final/blob/main/docs/media/NN_Diagram.jpg)
Overview:
...
(Discussion of this model can be found in [3]). A 2 layer feedforward network with 3 hidden layers was determined to be sufficient for our use-case, as we can see the in the neural network multivariate fitting results with 1 hidden layer (https://github.com/SelasiEtch/MPPT_Comparison_Final/blob/main/docs/media/NN_1_Hidden_Layer.png), 2 hidden layers (https://github.com/SelasiEtch/MPPT_Comparison_Final/blob/main/docs/media/NN_2_Hidden_Layers.png), and 3 hidden layers (https://github.com/SelasiEtch/MPPT_Comparison_Final/blob/main/docs/media/NN_3_Hidden_Layers.png). The network employs regression tactics in order to learn its own mapping of the input data to the desired irradiance output
...
Figure 3: Neural Network Irradiance Estimation Testing (https://github.com/SelasiEtch/MPPT_Comparison_Final/blob/main/docs/media/Figure_3.png)

3. Fuzzy Logic Inference System
System Diagram: (https://github.com/SelasiEtch/MPPT_Comparison_Final/blob/main/docs/media/Fuzzy_Inference_Diagram.png)
Overview:
...
Figure 4: Rules for the Fuzzy Logic Controller (https://github.com/SelasiEtch/MPPT_Comparison_Final/blob/main/docs/media/Figure_4.png)


Figure 5: Membership Functions for the Fuzzy Logic Controller
(https://github.com/SelasiEtch/MPPT_Comparison_Final/blob/main/docs/media/Figure_5_a.png, https://github.com/SelasiEtch/MPPT_Comparison_Final/blob/main/docs/media/Figure_5_b.png, https://github.com/SelasiEtch/MPPT_Comparison_Final/blob/main/docs/media/Figure_5_c.png)
...
Figure 6: Wi-Fi Transmission of Temperature Data (https://github.com/SelasiEtch/MPPT_Comparison_Final/blob/main/docs/media/Figure_6.png)


# 4. Evaluation and Results

Although we were able to get most our our hardware and software working in an open-loop environment, we were not able to get things working in a closed-loop setting for the comparison study due to multiple setbacks and pitfalls thatg we encountered during the implementation process.
