...
Figure 2: High Level Schematic of Arduino Motor Driver Shield (Left) and Project Implementation (Right)
...
(Further discussion of this model can be found in [3]). A 2 layer feedforward network with 3 hidden layers was determined to be sufficient for our use-case. The network employs regression tactics in order to learn its own mapping of the input data to the desired irradiance output
...
Figure 6: Wi-Fi Transmission of Temperature Data
